      ...
      <section className='bg-white relative'>
        <div className='container pt-[6rem] pb-[8rem]'>
          <div className="">
            ...
            <div className="mt-16">
              <div className=" text-center font-rusilla text-primary text-[4.5rem] leading-[0.9] md:text-[5.5rem] md:leading-[0.9] lg:text-[6.5rem] lg:leading-[0.9] xl:text-[7.5rem] xl:leading-[0.9]">
