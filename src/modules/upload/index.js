        ...
        <div className='container'>
          <div className="pt-16 md:pt-14 lg:pt-16 xl:pt-20 pb-6">
            <h1 className="font-rusilla flex flex-row items-center justify-center gap-2 md:gap-4 text-center text-[1.4rem] leading-[0.7] md:text-[2rem] md:leading-[0.8] lg:text-[2.8rem] lg:leading-[0.8] xl:text-[3.15rem] xl:leading-[0.7] text-primary">
              <span>ChiomA</span>
              <span className="text-xl md:text-[2rem] xl:text-[3.5rem] text-secondary">x</span>
              <span>OnyEkachI</span>
            </h1>
            <p className="mt-10 font-rusilla flex flex-col text-center text-[3.3rem] leading-[0.9] md:text-[3.9rem] md:leading-[0.9] xl:text-[6.25rem] xl:leading-[0.9] text-primary">
              Our wedding,<br />
